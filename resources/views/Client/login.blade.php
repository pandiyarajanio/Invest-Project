                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="breadcrumbs-wrap">
                            <h1 class="breadcrumb-title">Sign In</h1>
                            ...
                            <div class="login-form">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="social-login mb-3">
                                        <ul>
                                            <li><a href="/forget" class="theme-cl FontSizeQu" style="font-size: 15px; color: #dd2c2c;">Forget Password ?</a></li>
                                            <li><a href="#" class="theme-cl FontSizeQu" style="padding: 1px;
                                                color: #35aa35; font-size: 15px;">Login With Whatsapp OTP </a></li>
                                        </ul>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <button type="submit" name="validate" class="btn btn-md full-width pop-login"
                                            onclick="validateEmail()">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
