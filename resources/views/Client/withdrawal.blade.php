            ...
            <ul class="nav-menu">
              ...
              <li class="active"><a href="#">Funds<span class="submenu-indicator"></span></a>
                <ul class="nav-dropdown nav-submenu">
                  ...
                  <li class="active"><a href="/withdrawal">Withdrawal</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 p-0 hidden-xs ">
            <div class="dashboard-navbar">
              ...
              @if(auth()->user()->avatar)
                <img src="{{ asset('storage/avatars/' . auth()->user()->avatar) }}" class="img-fluid avater" alt="">
                @else
                <p>No Record Found</p>
                @endif
											...
											<div class="submit-section">
												<div class="form-row">
													...
													<div class="form-group col-md-6">
														...
														<input type="email" class="form-control" value="50000">
													</div>
												...
												<div class="form-group col-md-12" align="center">
													<span class="payment_status inprogress">	<label>Due to insufficient balance (Below Rs:200000) ,your account not eligible for next day trading  </label></span>
													...
													<div class="form-group col-lg-12 col-md-12">
															<button class="btn btn-theme" type="submit">Request Amount </button>
														</div>
												</div>
											</div>
											<!-- Basic info -->
