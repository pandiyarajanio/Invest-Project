        ...
        <nav id="navigation" class="navigation navigation-landscape">
          <div class="nav-header">
            <a class="nav-brand" href="#">
              <img src="assets/img/Stockz-Buddy-Best-Share-Market-Tamil-YouTube-Channel.jpg" class="logo centerimagecode" alt="" />
            </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h4 class="fontxlsize" style="font-weight: bold;  font-size: 33px;">FORGET PASSWORD</h4>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="log_wrap mediascreensize" style="width: 45%; margin-left: 30%;">
                            <!-- <h4 class="fontxlsize">FORGET PASSWORD</h4> -->
                            <div class="login-form">
                                <form action="{{ route('login') }}" method="POST">
                                    @csrf

                                    <div class="form-group">
                                        <label for="email" class="fontxllabalbox">Enter Your Email ? <span style="color: red;">*</span></label>
                                        <input type="text" name="email" id="email" class="form-control" required>
                                    </div>

                                    <br>
                                    <div class="form-group">
                                        <button type="submit"  name="validate"  class="btn btn-md full-width pop-login forgetpasswordlinkbtn">Submit </button>
                                    </div>
                                </form>
                            </div>
                        </div>
