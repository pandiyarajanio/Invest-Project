        ...
        <nav id="navigation" class="navigation navigation-landscape">
          ...
          <div class="nav-menus-wrapper" style="transition-property: none;">
            ...
            <ul class="nav-menu">
              ...
              <li class="active"><a href="#">Funds<span class="submenu-indicator"></span></a>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                ...
                <div class="d-user-avater" style="margin:0px">
                  ...
                  <img src="{{ asset('storage/profile_images/' . Auth::user()->profile_image) }}"
                    class="img-fluid avater imagelasted" alt="" width="20%"
                ...
                <div class="dashboard_container">
                  ...
                  <div class="dashboard_container_body p-4">
                    ...
                    <div class="submit-section">
                      ...
                      @endif
                      <form method="POST" action="{{ route('user-transfer') }}" enctype="multipart/form-data"
                        id="paymentForm">
                        @csrf
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="off_modeofpayment">Mode of Payment</label>
                            <select id="off_modeofpayment" name="off_modeofpayment" class="form-control">
                          ...
                          <div class="form-group col-md-6">
                            <label for="off_upi">UPI Mobile Number / UPI ID</label>
                            <input type="number" class="form-control" name="off_upi" id="off_upi" value="" disabled required>
                          </div>


                          <div class="form-group col-md-6">
                            <label for="off_typeofaccount">Type of Account</label>
                            <input type="text" class="form-control" name="off_typeofaccount" id="off_typeofaccount"
                              value="" disabled required>
                          </div>


                          <div class="form-group col-md-6">
                            <label for="off_holdername">Account Holder Name</label>
                            <input type="text" class="form-control" name="off_holdername" id="off_holdername" value=""
                             required >
                          </div> 
                          ...
                          <div class="form-group col-md-6">
                            <label for="off_bankname">Bank Name</label>
                            <input type="text" name="off_bankname" id="off_bankname" class="form-control" value="" disabled required>
                          </div>

                          <div class="form-group col-md-6">
                            <label for="off_accountnumber">Account Number</label>
                            <input type="text" name="off_accountnumber" id="off_accountnumber" class="form-control"
                              value="" disabled required>
                          </div>

                          <div class="form-group col-md-6">
                            <label for="off_branchname">Branch Name</label>
                            <input type="text" name="off_branchname" id="off_branchname" class="form-control" value="" disabled required>
                          </div>

                          <div class="form-group col-md-6">
                            <label for="off_ifsc">IFSC Number</label>
                            <input type="text" name="off_ifsc" id="off_ifsc" class="form-control" value="" disabled required> 
                          </div>


                          <div class="form-group col-md-6">
                            <label for="off_city">City</label>
                            <input type="text" name="off_city" id="off_city" class="form-control" value="" disabled required>
                          </div>

                          <div class="form-group col-md-6">
                            <label for="off_amount">Amount</label>
                            <input type="number" name="off_amount" id="off_amount" class="form-control" value="" required>
                          </div>


                          <div class="form-group col-md-6">
                            <label for="off_image">Upload Receipt</label>
                            <input type="file" id="off_image" name="off_image" accept=".jpg, .jpeg, .png"
                              onchange="fileValidate()" required>
                            <div id="file-validation-message" style="padding: 10px;"></div>
                          </div>
                          <script>
                            function fileValidate() {
                              var fileInput = document.getElementById('off_image');
                        ...
                        <script>
                          document.getElementById('off_modeofpayment').addEventListener('change', function () {
                            var selectedOption = this.value;
                            var upiInput = document.getElementById('off_upi');
                            var holdername = document.getElementById('off_holdername');
                            var typeofaccount = document.getElementById('off_typeofaccount');
                            var bankname = document.getElementById('off_bankname');
                            var accountnumber = document.getElementById('off_accountnumber');
                            var branchname = document.getElementById('off_branchname');
                            var ifsccode = document.getElementById('off_ifsc');
                            var city = document.getElementById('off_city');
                            var amount = document.getElementById('off_amount');
                        
                            if (selectedOption === 'UPI Payment') {
                              upiInput.disabled = false;
                              // holdername.disabled = true;
                              typeofaccount.disabled = true;
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>100000</td>
                            <td><span class="payment_status complete">0.1%</span> </td>
                            <td>1000 </td>
                            <td>101000 </td>
                          </tr>
