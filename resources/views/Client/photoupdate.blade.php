            ...
            <ul class="nav-menu">
              ...
              <li class="active"><a href="#">Settings<span class="submenu-indicator"></span></a>
                <ul class="nav-dropdown nav-submenu">
                  ...
                  <li class="active"><a href="/photoupdate">Edit Photo</a></li>
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-lg-12 col-md-12">
                              <button class="btn btn-theme imageupdates" type="submit"
                                style="margin-top: 41px; margin-left: -12px;">Save Changes</button>
                            </div>
                          </form>
                        </div>
