              ...
              <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="dashboard_stats_wrap widget-1">
                  <div class="dashboard_stats_wrap_content" align="center">
                    <h4>
                      @if (isset($usertransitionsByUser[auth()->id()]))
                          {{ $usertransitionsByUser[auth()->id()]->sum('off_amount') }}
                      @else
                         <p style="font-size: 15px; font-weight: 700; font-style: italic;">Not available</p>
                      @endif
                  </h4>
