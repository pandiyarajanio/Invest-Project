                    ...
                    <div class="nav-menus-wrapper" style="transition-property: none;">
                        ...
                        <ul class="nav-menu">
                            ...
                            <li class="active"><a href="#">Reports<span class="submenu-indicator"></span></a>
                                <ul class="nav-dropdown nav-submenu">
                                    <li class="active"><a href="/accountssummary">Accounts Summary</a></li>
                        ...
                        <div class="dashboard-navbar">
                            ...
                            <div class="d-navigation">
                                <ul id="side-menu">
                                    ...
                                    <li><a href="profile.html"><i class="ti-heart"></i> Profile</a></li>
                                    <li class="dropdown ">
                                        <a href="#"><i class="ti-layers"></i>Settings<span
                                                class="ti-angle-left"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li><a href="eprofile.html">Edit Profile</a></li>
                                            <li><a href="ephoto.html">Edit Photo</a></li>
                                            <li><a href="ebank.html">Edit Bank Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown active">
                                        <a href="#"><i class="ti-download"></i>Reports<span
                                                class="ti-angle-left"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li><a href="accountssummary.html">Accounts Summary</a></li>
                                            <li><a href="tradesummary.html">Trading Summary</a></li>
                                        </ul>
                                    </li>
