            ...
            <div class="dashboard-navbar">
              ...
              <div class="d-navigation">
                <ul id="side-menu">
                  ...
                  <li class="active"><a href="/profile"><i class="ti-heart"></i> Profile</a></li>
                  <li class="dropdown">
                    ...
                    <div class="submit-section">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          <label><strong> Account ID : </strong></label> <label>{{ Auth::user()->id }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong> Name : </strong></label> <label>{{ Auth::user()->name }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong> Email : </strong></label> <label>{{ Auth::user()->email }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong> Mobile / WhatsApp Number : </strong></label> <label>{{
                            Auth::user()->phonenumber }}</label>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label>{{ optional($userDetails)->city?? 'Not available' }}</label>
                        </div>
                    
                        <div class="form-group col-md-6">
                            <label><strong>PAN Number: </strong></label>
                            <label>{{ optional($userDetails)->pannumber?? 'Not available' }}</label>
                        </div>
                  ...
                  <div class="dashboard_container_body p-4">
                    ...
                    <div class="submit-section">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          <label><strong> Account Type : </strong></label> <label>{{ optional($userDetails)->Account_type?? 'Not available' }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong> Account Holder Name : </strong></label> <label>{{ optional($userDetails)->holder_name?? 'Not available' }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong>Bank Name :</strong></label> <label> {{ optional($userDetails)->Bank_Name?? 'Not available' }}</label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong>Account Number :</strong></label> <label>{{ optional($userDetails)->Account_Number?? 'Not available' }}</label>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <label id="branch">
                            {{ optional($userDetails)->Branch?? 'Not available' }}
                          </label>
                        </div>

                        <div class="form-group col-md-6">
                          <label><strong>IFSC Code :</strong></label>
                          <label> {{ optional($userDetails)->IFSC_Code?? 'Not available' }}</label>
                        </div>
                        <div class="form-group col-md-6">
                          <label><strong> City : </strong></label>
                          <label>{{ optional($userDetails)->bank_city?? 'Not available' }}</label>
                        </div>
                      </div>
                    </div>
