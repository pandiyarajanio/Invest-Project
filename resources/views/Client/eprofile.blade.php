          ...
          <div class="nav-menus-wrapper" style="transition-property: none;">
            ...
            <ul class="nav-menu">
              ...
              <li class="active"><a href="#">Settings<span class="submenu-indicator"></span></a>
                <ul class="nav-dropdown nav-submenu">
                  <li class="active"><a href="/eprofile">Edit Profile</a></li>
                ...
                <div class="dashboard_container">
                  ...
                  <div class="dashboard_container_body p-4">
                    ...
                    <div class="submit-section">
                      <form method="POST" action="{{ route('update-user-city') }}" onsubmit="return validateForm()">
                        @csrf
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="pannumber" id="pannumber"
                              onblur="validatePanNumber(this)" required />
                          ...
                          <div class="form-group col-md-6">
                            <br><button class="btn btn-theme" type="submit" style="margin-top: 10px;">Save
                              Changes</button>
                          </div>
                        </div>
                      </form>
                      <script>
                        function validatePanNumber(inputtxt) {
                          var panPattern = /^[A-Z]{5}[0-9]{4}[A-Z]{1}$/;
                          if (inputtxt.value.match(panPattern)) {
                            return true;
                          } else {
                            document.getElementById("panError").innerHTML = "Please enter a valid PAN number";
                            return false;
                          }
                        }
                      </script>
