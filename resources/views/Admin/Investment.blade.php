                            ...
                            <ul id="side-menu">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="nav nav-second-level" style="color: #fff;">
                                        <li><a href="{{ url('admin/Investment')}}"
                                        ...
                                        <table class="table table-bordered ">
                                            <thead class="thead-dark ">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="bgColour">UserId</th>
                                                    <th scope="col" class="bgColour">Name</th>
                                                    <th scope="col" class="bgColour">Mode of Payment</th>
                                                    <th scope="col" class="bgColour">Amount</th>
                                                    <th scope="col" class="bgColour">View Receipt</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($usertransitions as $usertransition)
                                                <tr>
                                                    <td>{{ $usertransition->userid }}</td>
                                                    <td>{{ $usertransition->off_holdername }}</td>
                                                    <td>{{ $usertransition->off_modeofpayment }}</td>
                                                    <td>{{ $usertransition->off_amount }}</td>
                                                    <td><a href="{{ url('admin/Invoice', ['userId' => $usertransition->userid]) }}"
